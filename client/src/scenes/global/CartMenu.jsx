        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Box m="20px 0">
                        <FlexBox m="20px 0 ">
                            <Typography  color={shades.secondary[500]} variant="h5">TOPLAM TUTAR: </Typography>
                            <Typography fontWeight="bold" ml="10px" color={shades.primary[500]} variant="h5">${totalPrice}</Typography>
                        </FlexBox>
                        <Button
